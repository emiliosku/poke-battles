...
export const REPLAY = {
  ...
  source: "battle",
  status: "finished",
  winner: BATTLE_DOUBLES_FINISHED.winner,
  player1: { username: BATTLE_DOUBLES_FINISHED.player1_username, model: BATTLE_DOUBLES_FINISHED.model1 },
  player2: { username: BATTLE_DOUBLES_FINISHED.player2_username, model: BATTLE_DOUBLES_FINISHED.model2 },
  created_at: BATTLE_DOUBLES_FINISHED.created_at,
  finished_at: BATTLE_DOUBLES_FINISHED.finished_at,
  team1_snapshot: {
    name: "Doubles Sun",
    roster: [
      { species: "Incineroar", species_id: "incineroar", sprite_id: "incineroar" },
      { species: "Flutter Mane", species_id: "fluttermane", sprite_id: "fluttermane" },
    ],
  },
  team2_snapshot: {
    name: "Trick Room",
    roster: [
      { species: "Garchomp", species_id: "garchomp", sprite_id: "garchomp" },
      { species: "Roaring Moon", species_id: "roaringmoon", sprite_id: "roaringmoon" },
    ],
  },
